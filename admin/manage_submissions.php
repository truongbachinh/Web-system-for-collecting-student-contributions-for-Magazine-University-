                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="" name="manageSubmission" method="POST" id="managerTopics" enctype="multipart/form-data">
        ...
        <script>
            ...
            $(document).ready(function() {
                $("#managerTopics").validate({
                    ...
                    messages: {
                        topicName: {
                            required: "Please input information!",
                            minlength: "Please enter at least 3 characters",
                            onlyLetter: "Just input only alphabetical characters"
                        },
                        topicDes: {
                            required: "Please input information!",
                        ...
                        startDeadLine: {
                            required: "Please begin date of topic's deadline!",
                        },
                    }
                })
            })
