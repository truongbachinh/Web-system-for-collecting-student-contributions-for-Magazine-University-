                        ...
                        <form action="">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="inputName1" name="firstName" placeholder="Thu Thuy" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputName2">Last Name</label>
                                    <input type="text" class="form-control" id="inputName2" name="lastName" placeholder="Nguyen" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail1">Email</label>
                                <input type="email" class="form-control" id="inputEmail1" placeholder="thuthuynguyen@gmail.com" name="inputEmail" required>
                            </div>
                            <div class="form-group">
