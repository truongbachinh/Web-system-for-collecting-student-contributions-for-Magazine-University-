...
class Google_Service_Pubsub extends Google_Service
{
  ...
  /** View and manage Pub/Sub submissions and subscriptions. */
  const PUBSUB =
  "https://www.googleapis.com/auth/pubsub";

  public $projects_subscriptions;
  public $projects_submissions;
  public $projects_submissions_subscriptions;
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->projects_submissions = new Google_Service_Pubsub_ProjectsSubmissions_Resource(
      $this,
      $this->serviceName,
      'submissions',
      array(
    ...
    $this->projects_submissions_subscriptions = new Google_Service_Pubsub_ProjectsSubmissionsSubscriptions_Resource(
      $this,
      $this->serviceName,
      'subscriptions',
      array(
        'methods' => array(
          'list' => array(
            'path' => 'v1/{+submission}/subscriptions',
            'httpMethod' => 'GET',
            'parameters' => array(
              'submission' => array(
                'location' => 'path',
...
class Google_Service_Pubsub_ProjectsSubscriptions_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a subscription to a given submission for a given subscriber. If the
   * subscription already exists, returns ALREADY_EXISTS. If the corresponding
   * submission doesn't exist, returns NOT_FOUND. If the name is not provided in the
   * request, the server will assign a random name for this subscription on the
   * same project as the submission. (subscriptions.create)
   *
   ...
   * but the new one has no association with the old subscription, or its submission
   * unless the same submission is specified. (subscriptions.delete)
   *
 ...
 *  <code>
 *   $pubsubService = new Google_Service_Pubsub(...);
 *   $submissions = $pubsubService->submissions;
 *  </code>
 */
class Google_Service_Pubsub_ProjectsSubmissions_Resource extends Google_Service_Resource
{

  /**
   * Creates the given submission with the given name. (submissions.create)
   *
   * @param string $name The name of the submission. It must have the format
   * `"projects/{project}/submissions/{submission}"`. `{submission}` must start with a letter,
   ...
   * @param array $optParams Optional parameters.
   * @return Google_Service_Pubsub_Submission
   */
  public function create($name, Google_Service_Pubsub_Submission $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Google_Service_Pubsub_Submission");
  }

  /**
   * Deletes the submission with the given name. Returns NOT_FOUND if the submission does
   * not exist. After a submission is deleted, a new submission may be created with the same
   * name; this is an entirely new submission with none of the old configuration or
   * subscriptions. Existing subscriptions to this submission are not deleted, but
   * their `submission` field is set to `_deleted-submission_`. (submissions.delete)
   *
   * @param string $submission Name of the submission to delete.
   * @param array $optParams Optional parameters.
   * @return Google_Service_Pubsub_Empty
   */
  public function delete($submission, $optParams = array())
  {
    $params = array('submission' => $submission);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Google_Service_Pubsub_Empty");
  }

  /**
   * Gets the configuration of a submission. (submissions.get)
   *
   * @param string $submission The name of the submission to get.
   * @param array $optParams Optional parameters.
   * @return Google_Service_Pubsub_Submission
   */
  public function get($submission, $optParams = array())
  {
    $params = array('submission' => $submission);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_Pubsub_Submission");
  }

  /**
   * Gets the access control policy for a resource. Is empty if the policy or the
   * resource does not exist. (submissions.getIamPolicy)
   *
   * @param string $resource REQUIRED: The resource for which policy is being
   * requested. Resource is usually specified as a path, such as,
   * projects/{project}.
  ...
  /**
   * Lists matching submissions. (submissions.listProjectsSubmissions)
   *
   * @param string $project The name of the cloud project that submissions belong to.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string pageToken The value returned by the last
   * ListSubmissionsResponse; indicates that this is a continuation of a prior
   * ListSubmissions call, and that the system should return the next page of data.
   * @opt_param int pageSize Maximum number of submissions to return.
   * @return Google_Service_Pubsub_ListSubmissionsResponse
   */
  public function listProjectsSubmissions($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Pubsub_ListSubmissionsResponse");
  }

  /**
   * Adds one or more messages to the submission. Returns NOT_FOUND if the submission does
   * not exist. The message payload must not be empty; it must contain either a
   * non-empty data field, or at least one attribute. (submissions.publish)
   *
   * @param string $submission The messages in the request will be published on this
   * submission.
   * @param Google_PublishRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Pubsub_PublishResponse
   */
  public function publish($submission, Google_Service_Pubsub_PublishRequest $postBody, $optParams = array())
  {
    $params = array('submission' => $submission, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
  ...
  /**
   * Sets the access control policy on the specified resource. Replaces any
   * existing policy. (submissions.setIamPolicy)
   *
   * @param string $resource REQUIRED: The resource for which policy is being
   * specified. Resource is usually specified as a path, such as,
   * projects/{project}/zones/{zone}/disks/{disk}.
  ...
  /**
   * Returns permissions that a caller has on the specified resource.
   * (submissions.testIamPermissions)
   *
   * @param string $resource REQUIRED: The resource for which policy detail is
   * being requested. Resource is usually specified as a path, such as,
   * projects/{project}.
 ...
 *  </code>
 */
class Google_Service_Pubsub_ProjectsSubmissionsSubscriptions_Resource extends Google_Service_Resource
{

  /**
   * Lists the name of the subscriptions for this submission.
   * (subscriptions.listProjectsSubmissionsSubscriptions)
   *
   * @param string $submission The name of the submission that subscriptions are attached
   * to.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string pageToken The value returned by the last
   * ListSubmissionSubscriptionsResponse; indicates that this is a continuation of a
   * prior ListSubmissionSubscriptions call, and that the system should return the next
   * page of data.
   * @opt_param int pageSize Maximum number of subscription names to return.
   * @return Google_Service_Pubsub_ListSubmissionSubscriptionsResponse
   */
  public function listProjectsSubmissionsSubscriptions($submission, $optParams = array())
  {
    $params = array('submission' => $submission);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Pubsub_ListSubmissionSubscriptionsResponse");
  }
}
...
class Google_Service_Pubsub_ListSubmissionSubscriptionsResponse extends Google_Collection
{
  protected $collection_key = 'subscriptions';
  protected $internal_gapi_mappings = array();
  public $nextPageToken;
...
class Google_Service_Pubsub_ListSubmissionsResponse extends Google_Collection
{
  protected $collection_key = 'submissions';
  protected $internal_gapi_mappings = array();
  public $nextPageToken;
  protected $submissionsType = 'Google_Service_Pubsub_Submission';
...
class Google_Service_Pubsub_Submission extends Google_Model
{
  protected $internal_gapi_mappings = array();
  public $name;
