...
//$submission = $conn->query("SELECT faculty.*,user.*, submission.* FROM (( faculty INNER JOIN submission ON faculty.f_id = submission.faculty_id) INNER JOIN user ON faculty.f_id = user.faculty_id) WHERE user.u_id = '$userId' AND user.role = 'manager-marketing'");
printf("SELECT faculty.*,user.*, submission.* FROM (( faculty INNER JOIN submission ON faculty.f_id = submission.faculty_id) INNER JOIN user ON faculty.f_id = user.faculty_id) WHERE user.u_id = '$userId' AND user.role = 'manager-marketing'");
                                ...
                                <div class="table-responsive p-t-10">
                                    <table class="table text-center">
                                        ...
                                        <tbody>
                                            ...
                                            $submissionInfor = $conn->query("SELECT user.*, submission.*, faculty.* FROM submission INNER JOIN user ON user.u_id = user.u_id INNER JOIN faculty ON faculty.f_id = user.faculty_id WHERE user.u_id = '$userId' AND user.role = 'manager-marketing'");
